        ...
        <Grid pt="md">
          <Grid.Col span={6}>
            <Stack gap="sm">
              ...
              {data.engaged_power !== false && item('Engaged power (kW)', data.engaged_power)}
              {data.available_power !== false && item('Available power (kW)', data.available_power)}
            </Stack>
          </Grid.Col>
          <Grid.Col span={6}>
            <Stack gap="sm">
          ...
          <Grid.Col span={6}>
            <Stack gap="sm">
              ...
              {data.declared_annual_usage !== false &&
                item('Declared annual usage (Smc/year)', data.declared_annual_usage)}
            </Stack>
          </Grid.Col>
          <Grid.Col span={6}>
            <Stack gap="sm">
